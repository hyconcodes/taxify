        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-neutral-200 bg-white dark:border-primary-600/30 dark:bg-primary-950">
            ...
            <div class="px-3 pb-2">
                <button
                    ...
                    class="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-neutral-600 transition hover:bg-neutral-100 dark:text-white/80 dark:hover:bg-white/[7%]"
                >
